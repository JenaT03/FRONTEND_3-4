<template>
    <Form @submit="submitContact" :validation-schema="contactFormSchema"> 
        <!--  Gọi phương thức submitContact khi form được submit. -->
        <div class="form-group">
            <label for="name">Tên</label>
            <Field name="name" type="text" class="form-control" v-model="contactLocal.name" />
            <!-- Mỗi trường được liên kết với contactLocal thông qua v-model. -->
...
<script>
    ...
    export default {
        ...
        emits: ["submit:contact", "delete:contact"], // Khai báo sự kiện mà component sẽ phát ra khi gửi form hoặc xóa liên hệ 
        props: { // dữ liệu từ component cha 
